...
if($isLang=="kr"){
	$page_name = "downloads";
	$edit = "편집";$edit_cancel="취소";
	$edit_save="저장";

}else{
	$page_name = "downloads_en";
	$edit = "edit";$edit_cancel="cancel";
	$edit_save="save";
...
<div class="subContainer">
  ...
  <div class="cus_subCont"  id="content-container">
    ...
    <div id="editor-container" style="width:900px; float:right; margin: 0px 0 100px 0; padding-left: 30px; display: none">
      <form name="form-page" method="post" action="../classes/common/PageAction.php">
        ...
        <input type="hidden" name="return_url" value="../support/downloads.php">
      ...
      <div style="text-align: right; margin-top: 20px">
        <button type="button" class="btn btn-default btn-sm" onclick="javascript:hideEditor()"><?=$edit_cancel?>
</button>
